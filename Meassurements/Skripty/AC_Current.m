...
title('Celkové harmonické zkreslení (THD)', 'FontSize', 12, 'FontWeight', 'bold');
...
% Uložení obrázku
% Uložení obrázku
saveas(gcf, '/home/pavel/modular-current-source/LaTeX/kapitola5/Figures/THD_AC.png');
saveas(gcf, '/home/pavel/modular-current-source/LaTeX/kapitola5/Figures/THD_AC.fig');
...
xlabel('Nastavená amplituda [A]', 'FontSize', 11);
ylabel('Výstupní amplituda [A]', 'FontSize', 11);
...
saveas(gcf, '/home/pavel/modular-current-source/LaTeX/kapitola5/Figures/nastavena_realna_amplituda.png');
saveas(gcf, '/home/pavel/modular-current-source/LaTeX/kapitola5/Figures/nastavena_realna_amplituda.fig');
